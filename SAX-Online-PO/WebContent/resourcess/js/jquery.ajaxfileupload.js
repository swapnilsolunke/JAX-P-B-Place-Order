...
(function($) {
    $.fn.ajaxfileupload = function(options) {
        var settings = {
          ...
          onComplete: function(response) { console.log('got response: '); console.log("Actual Respose is = "+response); console.log(this); },
          ...
          */
          var wrapElement = function(element) {
            ...
            $('#'+frame_id).load(function() {
            	console.log("Response >>: "+this.contentWindow.document.body.innerHTML);
            	$("#res").html(this.contentWindow.document.body.innerHTML);
